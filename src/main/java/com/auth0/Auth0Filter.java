    ...
    public void init(final FilterConfig filterConfig) throws ServletException {
        ...
        switch (signingAlgorithm) {
            ...
            case HS512:
                ...
                final String base64EncodedSecretStr = filterConfig.getServletContext().getInitParameter("auth0.base64_encoded_secret");
                Validate.notNull(base64EncodedSecretStr);
                final boolean base64EncodedSecret = Boolean.valueOf(base64EncodedSecretStr);
